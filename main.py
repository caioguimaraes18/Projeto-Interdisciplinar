...
while opcao1 != 3:
   ...
   #Vamos fazer a cibversão de decimal para binário, hexadecimal e octal 
    if escolha == "1":
        while True:
            num_decimal = int(input("Digite o número decimal: "))
        ...
        #
        decimal_to_binary = bin(num_decimal)[2:]  # Removendo o prefixo '0b'
        decimal_to_hexadecimal = hex(num_decimal)[2:]  # Removendo o prefixo '0x'
        decimal_to_octal = oct(num_decimal)[2:] # Removendo o prefixo '0o'    
